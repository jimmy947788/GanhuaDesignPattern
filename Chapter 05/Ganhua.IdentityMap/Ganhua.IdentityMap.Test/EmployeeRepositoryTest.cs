...
using Ganhua.IdentityMap.Repository;
using Microsoft.VisualStudio.TestTools.UnitTesting;

namespace Ganhua.IdentityMap.Test
{
    [TestClass]
    public class EmployeeRepositoryTest
    {
        ...
        public void The_Identity_Map_Will_Return_The_Instance_Of_An_Employee_From_A_Repository()
        {
            ...
            {
                Id = new Guid("0b7f95b0-be8b-4758-a994-c4ab81d33b40"),
                FirstName = "Steve",
                LastName = "Mills"
            };
            ...
            EmpoyeeAFromRepositoryA.LastName = "Mills-Stone"; //call by reference
